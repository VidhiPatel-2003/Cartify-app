...
const Login: React.FC = () => {
  ...
  // const { formtype, setFormType } = useContext(ShopContext);
  ...
  //       <div className='inline-flex items-center gap-2 mb-2 mt-10'>
  //         <hr className='border-none h-[1.5px] w-7 bg-gray-700' />
  //         <p className='text-3xl font-serif' >{formtype}</p>
  //         <hr className='border-none h-[1.5px] w-7 bg-gray-700' />
  //       </div>
  ...
  //           <input type='text' name='name' value={values.name} placeholder='Name' className='w-full py-2 px-3 border border-gray-400' required />
  ...
  //         ""
  //       )}
  //       <label htmlFor='confirmpassword' className='text-gray-800  mr-[300px] text-5x font-semibold'>ConfirmPassword :-</label>
  //       <input name='confirmpassword' value={values.confirmpassword} type='password' onChange={handleChange} placeholder='ConfirmPassword' className='w-full py-2 px-3 border border-gray-400' required />
  //       {errors.confirmpassword && touched.confirmpassword ? (
  //         <>
  //           <p>{errors.confirmpassword}</p>
  ...
  //       <div className='w-full flex items-center justify-between'>
  //         <p>Forgot Password</p>
  //         {formtype === "Login" ? <p onClick={() => setFormType("Sign Up")} className='cursor-pointer '>Create account</p> : <p onClick={() => setFormType("Login")} className='cursor-pointer '>Sign In</p>}
  //       </div>
  //       {formtype === "Login" ? <button type='submit' className='w-full py-2 bg-gray-700 text-white font-semibold mt-3'>Sign In</button> : <button type='submit' className='w-full py-2 bg-gray-700 text-white font-semibold mt-3'>Sign Up</button>}
  //       {formtype === "Login" ? <button className='w-full py-2 bg-gray-700 text-white font-semibold mt-3 flex items-center justify-center'><FcGoogle className='text-4xl px-2' />Sign in with Google</button> : <button className='w-full py-2 bg-gray-700 text-white font-semibold mt-3 flex items-center justify-center '><FcGoogle className='text-4xl px-2' />Sign Up with Google</button>}
